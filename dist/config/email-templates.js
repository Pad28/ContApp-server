...
exports.forgotPasswordEmailTemplate = exports.checkEmailTemplate = void 0;
const envs_1 = require("./envs");
// Retorna una cadena con el html del correo de verificación
const checkEmailTemplate = (token) => `
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="content">
                ...
                <br>
                <a href="${envs_1.envs.API_SERVICE}/register/${token}">Confirmar registro</a>
            </td>
        </tr>
    </table>
    <div class="footer">
...
exports.checkEmailTemplate = checkEmailTemplate;
const forgotPasswordEmailTemplate = (token) => `
<!DOCTYPE html>
<html>
<head>
    ...
    <table align="center" width="600" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td style="text-align: center; padding: 30px; height: 300px;" >
                ...
                <br>
                <a  style="font-family: 'Gabarito';" href="${envs_1.envs.API_SERVICE}/forgot-pasword/${token}" >Crear cuenta</a>
            </td>
        </tr>
        <tr>
