/*
  ...
  - You are about to drop the column `aciertos` on the `ActividadContestada` table. All the data in the column will be lost.
  - You are about to drop the column `calificacion` on the `ActividadContestada` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `ActividadContestada` DROP COLUMN `aciertos`,
