/*
  ...
  - Made the column `id_material` on table `Publicacion` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE `Publicacion` MODIFY `id_material` VARCHAR(38) NOT NULL;
